...
(function () {
  ...
  function _activateWaiting() {
    if (!_waitingWorker) { window.location.reload(); return; }
  ...
  function _notifyUpdate() {
    ...
    b.onclick = _activateWaiting;
    document.body.appendChild(b);
    setTimeout(function () { b.style.opacity = '0'; b.style.transition = 'opacity .5s'; setTimeout(function () { b.remove(); }, 500); }, 15000);
  }
