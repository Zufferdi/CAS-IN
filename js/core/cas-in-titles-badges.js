...
(function() {
  ...
  const TITLES = [
    ...
    // ── Titres saga v56-v62 (sagas étendues + journalisme + DFIR pures) ──
    { id: 'sarine_protector', label: 'Protecteur de Sarine', icon: '🏰',
      description: 'Saga Sarine complétée avec mention Or.',
      condition: (_, badges) => badges.affaire_sarine === 'or' },
    { id: 'aar_frutigen_guard', label: 'Sentinelle d\'Aar-Frutigen', icon: '🏛',
      description: 'Saga Aar-Frutigen complétée avec mention Or.',
      condition: (_, badges) => badges.affaire_aar_frutigen === 'or' },
    { id: 'singine_master', label: 'Maître de la Singine', icon: '🧀',
      description: 'Saga Singine complétée avec mention Or.',
      condition: (_, badges) => badges.affaire_singine === 'or' },
    { id: 'gemmi_keeper', label: 'Gardien de la Gemmi', icon: '📷',
      description: 'Saga Gemmi complétée avec mention Or.',
      condition: (_, badges) => badges.affaire_gemmi === 'or' },
    { id: 'csem_artisan', label: 'Artisan du CSEM', icon: '⚙',
      description: 'Saga CSEM complétée avec mention Or.',
      condition: (_, badges) => badges.affaire_csem === 'or' },
    { id: 'noirmont_detective', label: 'Inspecteur du Noirmont', icon: '🔍',
      description: 'Saga Noirmont complétée avec mention Or.',
      condition: (_, badges) => badges.affaire_noirmont === 'or' },
    { id: 'mistral_industrial', label: 'Sentinelle Industrielle', icon: '🏭',
      description: 'Saga Mistral complétée avec mention Or.',
      condition: (_, badges) => badges.affaire_mistral === 'or' },
    { id: 'tavajjoh_defender', label: 'Défenseur de Tavajjoh', icon: '🇮🇷',
      description: 'Saga Tavajjoh complétée avec mention Or.',
      condition: (_, badges) => badges.affaire_tavajjoh === 'or' },
    { id: 'beznau_journalist', label: 'Journaliste de Beznau', icon: '☢',
      description: 'Saga Beznau complétée avec mention Or.',
      condition: (_, badges) => badges.affaire_beznau === 'or' },
    { id: 'gruyere_revealer', label: 'Révélateur Gruyère', icon: '🧀',
      description: 'Saga Gruyère Gate complétée avec mention Or.',
      condition: (_, badges) => badges.affaire_gruyere === 'or' },
    { id: 'lobby_investigator', label: 'Enquêteur du Palais', icon: '🏛',
      description: 'Saga Lobby parlementaire complétée avec mention Or.',
      condition: (_, badges) => badges.affaire_lobby === 'or' },
    { id: 'unifr_scholar', label: 'Veilleur Académique', icon: '🔬',
      description: 'Saga UNIFR complétée avec mention Or.',
      condition: (_, badges) => badges.affaire_unifr === 'or' },
    { id: 'aurora_csirt', label: 'Chasseur d\'Aurore', icon: '🌌',
      description: 'Saga Aurora Borealis (APT29) complétée avec mention Or.',
      condition: (_, badges) => badges.affaire_aurora === 'or' },
    { id: 'sarine_glane_consultant', label: 'Consultante de Sarine-Glâne', icon: '☁',
      description: 'Saga Sarine-sur-Glâne (cloud poisoning) complétée avec mention Or.',
      condition: (_, badges) => badges.affaire_sarine_glane === 'or' },
    { id: 'mbeki_collective', label: 'Plume du Collectif', icon: '📰',
      description: 'Saga Mbeki (bavure policière) complétée avec mention Or.',
      condition: (_, badges) => badges.affaire_mbeki === 'or' },

    // ── Titres méta (toutes sagas, achievement legendaire, etc.) ──
    { id: 'saga_completionist', label: 'Complétiste des sagas', icon: '👑',
      description: 'Toutes les 25 sagas complétées (≥ Bronze).',
      condition: (_, badges) => Object.keys(badges).length >= 25 },
