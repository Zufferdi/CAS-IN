...
(function () {
  ...
  const ARC_TO_ACHIEVEMENT = {
    ...
    'premiers_reflexes_cyber': 'arc_premiers_reflexes',
    // ─── Arcs auto-générés (v2.94) — voir scripts/build_npc_arcs_v2.py ───
    'forensics_lead_zh': 'arc_forensics_lead_zh',
    'ofcs_coordinator': 'arc_ofcs_coordinator',
    'fbi_legat_bern': 'arc_fbi_legat_bern',
    'ge_prosecutor_cyber': 'arc_ge_prosecutor_cyber',
    'ciso_logitech': 'arc_ciso_logitech',
    'compliance_bs': 'arc_compliance_bs',
    'fr_prosecutor_cyber': 'arc_fr_prosecutor_cyber',
    'vs_prosecutor_cyber': 'arc_vs_prosecutor_cyber',
    'fedpol_crd_cyber': 'arc_fedpol_crd_cyber',
    'cicr_dpo': 'arc_cicr_dpo',
    'ddps_general_counsel': 'arc_ddps_general_counsel',
    'interpol_europol_liaison': 'arc_interpol_europol_liaison',
    'mpc_procureur_federal': 'arc_mpc_procureur_federal',
    'ofs_rssi_fedch': 'arc_ofs_rssi_fedch',
    'pjf_undercover_lead': 'arc_pjf_undercover_lead',
    'vd_prosecutor_cyber': 'arc_vd_prosecutor_cyber',
    'vs_polcant_cyber': 'arc_vs_polcant_cyber',
    'compass_security_lead_forensic': 'arc_compass_security_lead_forensic',
    'ofj_eimp_bilateral_de': 'arc_ofj_eimp_bilateral_de',
    'pfpdt_lobsiger_office': 'arc_pfpdt_lobsiger_office',
    'src_director': 'arc_src_director',
    'expert_kudelski_security': 'arc_expert_kudelski_security',
    'fr_polcant_cyber': 'arc_fr_polcant_cyber',
    'ncsc_govcert_lead': 'arc_ncsc_govcert_lead',
  };
