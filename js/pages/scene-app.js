...
const ILLUSTRATIONS = {
  ...
  incident: `<svg viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg"><g stroke="var(--atm-accent)" stroke-width="1.2" fill="none"><path d="M100,20 L120,75 L80,75 Z" stroke-width="2"/><path d="M100,40 L100,60" stroke-width="2.5"/><circle cx="100" cy="68" r="2" fill="var(--atm-accent)"/><path d="M55,85 L145,85" stroke-dasharray="2 2" opacity=".5"/></g></svg>`,
  investigation: `<svg viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg"><g stroke="var(--atm-accent)" stroke-width="1.2" fill="none"><circle cx="85" cy="45" r="20" stroke-width="2"/><path d="M100,60 L130,80" stroke-width="3"/><path d="M78,38 Q85,30 95,38" stroke-width="1.5" opacity=".8"/><circle cx="85" cy="45" r="3" fill="var(--atm-accent)" opacity=".6"/></g></svg>`,
