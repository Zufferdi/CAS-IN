...
const CANTON_DATA = {
  ...
  VD: { name: "Vaud", scenarios: ["ncmec-cypertip", "lockbit-victime", "comparis_2021", "unine_2022", "epfl-recherche-lai-fuite-chine", "epfl-laboratoire-ia-medicale-chine", "crypto-tinder-pig-butchering-vaud", "logitech-clop-zero-day-supply-chain", "72969-infractions-vaud", "adn-genealogique-cold-case", "cloud-aws-s3-leak", "easy-mobile-perdu-train", "eu-crypto-kidnapping", "eu-frontex-deepfake-asylum", "iot-camera-compromise", "mineur-etranger-garde-a-vue", "perquisition-conjugale", "revenge-porn-deepfake-vd"] },
  VS: { name: "Valais", scenarios: ["vetroz-akira", "sati-bec", "rajeunissement-ia", "saxon-curatelle", "competence-mpc-vs", "hydro-valais", "audit-prestataire-systemique", "bec-pme-geneve-italie", "easy-aide-grand-mere-arnaque", "referent-milice-ransomware", "valais-cascade-12-communes", "vs-affaire-viege-1-avalanche-saas", "vs-affaire-viege-2-osint-bricolage", "vs-affaire-viege-3-mercure-lonza", "vs-affaire-viege-4-scada-mattmark", "vs-affaire-viege-5-eimp-milano", "vs-affaire-viege-6-perquisition-brig", "vs-affaire-viege-7-audience-tribunal"] },
  FR: { name: "Fribourg", scenarios: ["dab-villaz", "gruyere-coop-affinage-stuxnet", "hcfr-bec-transfer-deepfake", "cyber-justicier-vigilante-fr", "easy-pme-mot-passe-faible", "fr-affaire-sarine-1-premier-appel", "fr-affaire-sarine-2-eimp-stuttgart", "fr-affaire-sarine-3-coordination-cantons", "fr-affaire-sarine-4-expertise-unifr", "fr-affaire-sarine-5-audience-recevabilite", "secte-religieuse-fribourg-extorsion"] },
  NE: { name: "Neuchâtel", scenarios: ["faux-policiers", "harcelement-ne", "handala-hack-iran-rhne-stryker", "easy-suspicions-collegues", "evoting-cantonal", "exit-suicide-assiste-conteste", "unine_2022"] },
  JU: { name: "Jura", scenarios: ["delemont-forum", "jura-vishing-1m", "eu-cer-directive-incident", "pcap-network-intrusion-jura"] },
  BE: { name: "Berne", scenarios: ["ruag_2016", "palais_federal", "deepfake-electoral", "src-fonctionnaire-russe-kaspersky", "swatch-2020-ot", "whistleblower-ddps"] },
  ZH: { name: "Zurich", scenarios: ["attribution", "bitlocker", "bitlocker_froid", "mini-natels-prison-pochwies", "cistec-2025-sante", "contrefacon-douanes-enquirus", "easy-fake-news-elections", "frontieres", "swissport_2022", "lufthansa-zurich-aviation-cyber"] },
  SZ: { name: "Schwyz", scenarios: ["clone-vocal"] },
  TI: { name: "Tessin", scenarios: ["sati-bec", "lugano-dpfl-mafia-finance", "easy-cle-usb-trouvee", "eu-ai-act-cybersecurity", "telephone-scelles"] },
  ...
  TG: { name: "Thurgovie", scenarios: ["operation-alice", "cyberbullying-college-thurgovie"] },
  ...
  ZG: { name: "Zoug", scenarios: ["blanchiment-boites-lettres-fuite", "web3-defi-rug-pull-zoug"] },
