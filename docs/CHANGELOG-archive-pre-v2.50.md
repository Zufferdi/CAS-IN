# Changelog — Archive (versions antérieures à v2.50)

Versions historiques du projet CAS-IN, de la v0.1 (avril 2026) à la v2.49 (mai 2026).
Pour les versions récentes, voir [`CHANGELOG.md`](CHANGELOG.md).
